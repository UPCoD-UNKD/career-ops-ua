...
> **Auto-update disabled by user.** To manually check: `node update-system.mjs check`
> To apply: `node update-system.mjs apply` | To rollback: `node update-system.mjs rollback`
